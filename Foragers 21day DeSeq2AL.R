...
sampleNames <- c("ForA1AL_Control","ForA2AL_Control","ForB1AL_Control","ForB2AL_Control","ForC1AL_Control","ForC2AL_Control",
                 "ForA1AL_QMP","ForA2AL_QMP","ForB1AL_QMP","ForB2AL_QMP","ForC2AL_QMP","ForC3AL_QMP")
mydata <- read.table("Foragers 21day AL.txt", header = TRUE)
...
res <- results(dds)
write.table(res,"Foragers 21day ALresult.csv", sep = ",", row.names = TRUE)
head(res)
summary(res)
rld <- rlog(dds)
