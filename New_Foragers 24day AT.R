library("DESeq2")
setwd("D:/24.03.2020/Dokumente/Experiment/2019.04.09 Honeybee Cage experiment/Results/Result_geneid/New-Foragers 24day old/R analysis/New_Foragers 24day AT")
sampleNames <- c("NeFA1AT_Control","NeFA2AT_Control","NeFC1AT_Control","NeFC2AT_Control","NeFD1AT_Control","NeFD3AT_Control",
                 ...
                 "CoFA1AT","CoFA4AT","CoFC1AT","CoFC2AT","CoFD1AT","CoFD2AT")
mydata <- read.table("New_Foragers 24day AT.txt", header = TRUE)
...
res <- results(dds)
write.table(res,"New_Foragers 24day ATresult.csv", sep = ",", row.names = TRUE)
head(res)
summary(res)
rld <- rlog(dds)
