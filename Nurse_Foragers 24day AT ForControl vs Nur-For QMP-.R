library("DESeq2")
setwd("E:/24.03.2020/Dokumente/Experiment/2019.04.09 Honeybee Cage experiment/Results/Result_geneid/Nures-Foragers 24day old/R analysis")
...
mydata <- read.table("Nurse_Foragers 24day AT ForControl vs Nur-For QMP-.txt", header = TRUE)
...
res <- results(dds)
write.table(res,"Nurse_Foragers 24day AT ForControl vs Nur-For QMP- result.csv", sep = ",", row.names = TRUE)
head(res)
summary(res)
rld <- rlog(dds)
