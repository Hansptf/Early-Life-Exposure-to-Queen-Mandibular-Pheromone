library("DESeq2")
setwd("D:/24.03.2020/Dokumente/Experiment/2019.04.09 Honeybee Cage experiment/Results/Result_geneid/New-Foragers 24day old/R analysis/New_Foragers 24day MB")
sampleNames <- c("NeFA1MB_Control","NeFA2MB_Control","NeFC1MB_Control","NeFC2MB_Control","NeFD1MB_Control","NeFD3MB_Control",
                 "NeFA1MB_QMP","NeFA2MB_QMP","NeFC1MB_QMP","NeFC2MB_QMP","NeFD2MB_QMP","NeFD3MB_QMP",
                 "CoFA1MB","CoFA4MB","CoFC1MB","CoFC2MB","CoFD1MB","CoFD2MB")
mydata <- read.table("New_Foragers 24day MB.txt", header = TRUE)
...
res <- results(dds)
write.table(res,"New_Foragers 24day MB.csv", sep = ",", row.names = TRUE)
head(res)
summary(res)
rld <- rlog(dds)
