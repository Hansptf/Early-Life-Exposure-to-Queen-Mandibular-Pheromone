...
sampleNames <- c("NuFA1AL_QMP","NuFA2AL_QMP","NuFC1AL_QMP","NuFC2AL_QMP","NuFD1AL_QMP","NuFD2AL_QMP",
                 "CoFA1AL","CoFA4AL","CoFC1AL","CoFC2AL","CoFD1AL","CoFD2AL")
mydata <- read.table("Nurse_Foragers 24day AL ForControl vs Nur-For QMP+.txt", header = TRUE)
...
res <- results(dds)
write.table(res,"Nurse_Foragers 24day AL ForControl vs Nur-For QMP+ result.csv", sep = ",", row.names = TRUE)
head(res)
summary(res)
