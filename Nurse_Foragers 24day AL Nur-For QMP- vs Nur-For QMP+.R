...
mydata <- read.table("Nurse_Foragers 24day AL Nur-For QMP- vs Nur-For QMP+.txt", header = TRUE)
...
res <- results(dds)
write.table(res,"Nurse_Foragers 24day AL Nur-For QMP- vs Nur-For QMP+result.csv", sep = ",", row.names = TRUE)
head(res)
summary(res)
